...
// node_modules/@ngxs/store/fesm2020/ngxs-store-internals.mjs
...
InitialState._value = {};
var INITIAL_STATE_TOKEN = new InjectionToken(NG_DEV_MODE$1 ? "INITIAL_STATE_TOKEN" : "", {
  providedIn: "root",
...
// node_modules/@ngxs/store/fesm2020/ngxs-store-operators.mjs
function isStateOperator(value) {
  return typeof value === "function";
}

// node_modules/@ngxs/store/fesm2020/ngxs-store.mjs
...
var CUSTOM_NGXS_EXECUTION_STRATEGY = new InjectionToken(NG_DEV_MODE$4 ? "CUSTOM_NGXS_EXECUTION_STRATEGY" : "");
var NGXS_EXECUTION_STRATEGY = new InjectionToken(NG_DEV_MODE$4 ? "NGXS_EXECUTION_STRATEGY" : "", {
  providedIn: "root",
  factory: () => {
...
var ROOT_STATE_TOKEN = new InjectionToken(NG_DEV_MODE$3 ? "ROOT_STATE_TOKEN" : "");
var FEATURE_STATE_TOKEN = new InjectionToken(NG_DEV_MODE$3 ? "FEATURE_STATE_TOKEN" : "");
var NGXS_PLUGINS = new InjectionToken(NG_DEV_MODE$3 ? "NGXS_PLUGINS" : "");
var NGXS_OPTIONS = new InjectionToken(NG_DEV_MODE$3 ? "NGXS_OPTIONS" : "");
...
NgxsConfig.ɵprov = ɵɵdefineInjectable({
  token: NgxsConfig,
  factory: () => (() => mergeDeep(new NgxsConfig(), inject(NGXS_OPTIONS)))(),
  providedIn: "root"
});
(() => {
...
InternalDispatchedActionResults.ɵfac = (() => {
...
var Store = class {
  ...
  initStateStream(initialStateValue) {
    ...
    if (storeIsEmpty) {
      ...
      const storeValues = defaultStateNotEmpty ? __spreadValues(__spreadValues({}, this._config.defaultsState), initialStateValue) : initialStateValue;
...
var NGXS_ROOT_STORE_INITIALIZER = new InjectionToken(NG_DEV_MODE2 ? "NGXS_ROOT_STORE_INITIALIZER" : "");
var NGXS_FEATURE_STORE_INITIALIZER = new InjectionToken(NG_DEV_MODE2 ? "NGXS_FEATURE_STORE_INITIALIZER" : "");
...
//# sourceMappingURL=chunk-CT6BAEKJ.js.map
